/*********************************************************************
   PROGRAM:    CSCI 241 Assignment 8, Part 1,2, and 3
   PROGRAMMER: Amol Shah
   LOGON ID:   z1723133
   DUE DATE:   04.26.2016
   FUNCTION:   This program builds and sorts lists using the quick
               sort algorithm also uses other functions as outline in the assignment hand out.
	       The algorithums are well known standardized logic was provided with the assignment. 
*********************************************************************/  
#include <iostream>
#include <iomanip>
#include <vector>
