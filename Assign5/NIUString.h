...
using std::ostream;	//Using declaration for ostream object
...
class NIUString {
	...
	public:
		...
		void clear() ;			//Delete dynamically allocated mem and bring to default state
		void reserve(size_t);		//Changes string capacity only
